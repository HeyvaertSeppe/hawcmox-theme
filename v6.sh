...
/* Base toolbar styling - don't touch height/overflow here to preserve vertical scrollbars! */
.x-toolbar {
    background: var(--hawc-panel-alt) !important;
    border: none !important;
}

/* ONLY override the top docked toolbar's height and overflow to prevent glitching middle screens */
...
/*
 * Logo sizing scaled up for larger visibility and mapped accurately.
 */
