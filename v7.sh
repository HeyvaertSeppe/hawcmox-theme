...
# HAWCMOX Proxmox UI Manager v5.2 - For Proxmox 9.2.2+
...
/* This targets the Node/VM toolbar specifically - Reverted to 36px */
...
/* --- THE ACTUAL TOP HEADER --- 
   Targets the main top banner by finding the logo dynamically */
