...
/* 
 * Proxmox 9.2.2 SVG replacement hack.
 * Forces the browser to intercept the SVG image source and replace it with the PNG.
 */
.proxmox-logo, 
img[src*="proxmox_logo"] {
    content: url('/pve2/images/hawcmox_logo.png') !important;
