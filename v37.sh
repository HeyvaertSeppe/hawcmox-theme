...
# HAWCMOX Proxmox UI Manager v7.0 - For Proxmox 8+ and 9.2.2+
...
/* --- SAFE PANEL & WINDOW THEMING --- 
   No border or box-shadow overrides are applied here to prevent ExtJS layout math crashes. 
   Only colors are altered. */
...
/* --- Push down Left Navigation Menu exactly as requested --- */
